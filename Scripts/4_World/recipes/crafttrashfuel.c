class CraftTrashFuel extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft trash fuel";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TrashCompactor");//you can insert multiple ingredients this way
		...
		InsertIngredient(1,"SodaCan_Pipsi");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TrashFuel");//add results here
